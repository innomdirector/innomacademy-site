          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-white/60 mt-4 leading-relaxed text-sm">
                INNO M Academy (ინო ემ აკადემია) გთავაზობს ონლაინ პროგრამირების კურსებს, AI-ის სწავლებას და ტექნოლოგიურ განათლებას ბავშვებისთვის, მოზარდებისთვის და ზრდასრულებისთვის.
              </p>
            </div>
